    ...
    public partial class display : Form
    {
        ...
        public display(ref string sqlname1)
        {
            ...
            switch(sqlname1)
            {
                ...
                case "Bom": { ShowName = "Bom"; pictureBox1.Image = imageList4.Images[1]; } break;
                case "PurchaseOrder": { ShowName = "Purchase Order"; pictureBox1.Image = imageList4.Images[1]; } break;
                case "PartSetting": { ShowName = "Tooling Setting"; pictureBox1.Image = imageList4.Images[0]; } break;
                case "CreateJob": { ShowName = "Create Job"; pictureBox1.Image = imageList4.Images[0]; } break;
                ...
                case "JobManagement": { ShowName = "Job Management"; pictureBox1.Image = imageList4.Images[0]; } break;
                    ...
                    //case "Shipping_FG_List": { ShowName = "Shipping FG List"; pictureBox1.Image = imageList4.Images[0]; } break;
            }
            lblModule.Text = ShowName;
            lbRootNode.Text = sqlname;
            ...
            try
            {
                ...
                foreach (var c in Data)
                {
                    ...
                    else
                    {
                        ...
                        else if (c.LinkNode.ToString().Equals("Shipping_AvgJobCard"))
                        {
                            ListItem.ImageIndex = 25;
                        }
                        else if (c.LinkNode.ToString().Equals("Shipping_FG_List"))
                        {
                            ListItem.ImageIndex = 26;
                        }
                        else if (c.LinkNode.ToString().Equals("Claim_List"))
                        {
                            ListItem.ImageIndex = 23;
                        }
                        else if (c.LinkNode.ToString().Equals("Return_FG"))
                        {
                            ListItem.ImageIndex = 23;
                        }
                        else if (c.LinkNode.ToString().Equals("Shipping_FG"))
                        {
                            ListItem.ImageIndex = 25;
                        }
                        else if (c.LinkNode.ToString().Equals("Bom"))
                        {
                            ListItem.ImageIndex = 23;
                        }
                        else if (c.LinkNode.ToString().Equals("Bom_List"))
                        {
                            ListItem.ImageIndex = 26;
                        }
                        else if (c.LinkNode.ToString().Equals("CreatePO"))
                        {
                            ListItem.ImageIndex = 19;
                        }
                        else if (c.LinkNode.ToString().Equals("ChargePO"))
                        {
                            ListItem.ImageIndex = 19;
                        }
                        else if (c.LinkNode.ToString().Equals("CreatePO_List"))
                        {
                            ListItem.ImageIndex = 23;
                        }
                        else if (c.LinkNode.ToString().Equals("Stock_Location"))
                        {
                            ListItem.ImageIndex = 23;
                        }
                        else if (c.LinkNode.ToString().Equals("CreateJob"))
                        {
                            ListItem.ImageIndex = 19;
                        }
                        else if (c.LinkNode.ToString().Equals("CreateJob_List"))
                        {
                            ListItem.ImageIndex = 26;
                        }
                        else if (c.LinkNode.ToString().Equals("Shipping_FG_Sell"))
                        {
                            ListItem.ImageIndex = 19;
                        }
                        else if (c.LinkNode.ToString().Equals("JobManagement"))
                        {
                            ListItem.ImageIndex = 19;
                        }
                        else if (c.LinkNode.ToString().Equals("ReportReceiveDAILY_PURCHASE_LIST"))
                        {
                            ListItem.ImageIndex = 5;
                        }
                        else if (c.LinkNode.ToString().Equals("ReportPO"))
                        {
                            ListItem.ImageIndex = 6;
                        }
                        else if (c.LinkNode.ToString().Equals("ReportJobCard"))
                        {
                            ListItem.ImageIndex = 15;
                        }
                        else if (c.LinkNode.ToString().Equals("ReportClaimPart"))
                        {
                            ListItem.ImageIndex = 18;
                        }
                        else if (c.LinkNode.ToString().Equals("ReportClaimFG"))
                        {
                            ListItem.ImageIndex = 18;
                        }
                        else if (c.LinkNode.ToString().Equals("ReportSellFG"))
                        {
                            ListItem.ImageIndex = 19;
                        }
                        else if (c.LinkNode.ToString().Equals("ReportConsumableBalance"))
                        {
                            ListItem.ImageIndex = 19;
                        }
                        else if (c.LinkNode.ToString().Equals("ReportConsumableBalance_Summary"))
                        {
                            ListItem.ImageIndex = 19;
                        }
                        else
                ...
                else
                {
                    try
                    {
                        ...
                        using (DataClasses1DataContext db = new DataClasses1DataContext())
                        {
                            ...
                            if (StockControl.dbClss.Permisstion(lbRootNode.Text, listView1.FocusedItem.ToolTipText.ToString(), ClassLib.Classlib.User) || ClassLib.Classlib.User.ToUpper().Trim() == "ADMIN")
                            {
